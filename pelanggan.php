...
$barang = mysqli_query($koneksi, "SELECT * FROM pelanggan");
?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="num" name="notelp" class="form-control mt-3" placeholder="no telp">
        <input type="text" name="alamat" class="form-control mt-3" placeholder="alamat">
      </div>
    
      <!-- Modal footer -->
      <div class="modal-footer">
      <button type="submit" class="btn btn-success" name="tambahpelanggan">Save</button>
