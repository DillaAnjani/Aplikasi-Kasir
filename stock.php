                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="index.php">
                                <div class="sb-nav-link-icon"><i class="fab fa-first-order-alt"></i>"></i></div>
                                Order
                            </a>
                            <a class="nav-link" href="stock.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-inventory-alt"></i></div>
                                Stock Barang
                            </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" name="deskripsi" class="form-control mt-3" placeholder="deskri psi produk">
      ...
      <button type="submit" class="btn btn-success" name="tambah produk">Close</button>
